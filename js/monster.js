...
class Paper extends AngryMonster{
    constructor(tile){
        super(tile, 18, 3);
        this.isPaper = true;
    }
...
class Scissors extends AngryMonster{
    constructor(tile){
        super(tile, 19, 2);
...
class Rock_Plus extends AngryMonster{
    constructor(tile){
        super(tile, 20, 8);
        this.isRock = true;
        this.base_bonus = 1;
...
class Paper_Plus extends AngryMonster{
    constructor(tile){
        super(tile, 21, 6);
        this.isPaper = true;
        this.base_bonus = 1;
...
class Scissors_Plus extends AngryMonster{
    constructor(tile){
        super(tile, 22, 4);
        this.isScissors = true;
        this.base_bonus = 1;
...
class Rock_Anti extends AngryMonster{
    constructor(tile){
        super(tile, 23, 4);
        this.isRock = true;
        this.anti_multiplier = -1;
...
class Paper_Anti extends AngryMonster{
    constructor(tile){
        super(tile, 24, 3);
        this.isPaper = true;
        this.anti_multiplier = -1;
...
class Scissors_Anti extends AngryMonster{
    constructor(tile){
        super(tile, 25, 2);
        this.isScissors = true;
        this.anti_multiplier = -1;
